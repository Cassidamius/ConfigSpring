...
insert into t_resc(id,name,resc_type,resc_string,priority,descn,version) values(2,'用户列表','MENU','/user',1,'',1);
insert into t_resc(id,name,resc_type,resc_string,priority,descn,version) values(3,'角色列表','MENU','/role',1,'',1);
insert into t_resc(id,name,resc_type,resc_string,priority,descn,version) values(4,'资源列表','MENU','/resource',1,'',1);
