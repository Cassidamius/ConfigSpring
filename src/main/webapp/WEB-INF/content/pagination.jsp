...
共${pageResultSet.pageInfo.totalRow}条，共${pageResultSet.pageInfo.totalPage}页；当前第${pageResultSet.pageInfo.currentPage}页；每页显示：
	...
	<c:if test="${pageResultSet.pageInfo.currentPage == 1 && pageResultSet.pageInfo.totalPage == 1}">首页&nbsp;&nbsp;上一页&nbsp;&nbsp;下一页&nbsp;&nbsp;末页</c:if>
	<c:if test="${pageResultSet.pageInfo.currentPage == 1 && pageResultSet.pageInfo.totalPage > 1}">首页&nbsp;&nbsp;上一页<a href="javascript:changePage(${pageResultSet.pageInfo.currentPage + 1},${pageResultSet.pageInfo.totalRow});">下一页</a>&nbsp;&nbsp;<a href="javascript:changePage(${pageResultSet.pageInfo.totalPage},${pageResultSet.pageInfo.totalRow});">末页</a></c:if>
	...
	<c:if test="${pageResultSet.pageInfo.currentPage > 1 && pageResultSet.pageInfo.totalPage == pageResultSet.pageInfo.currentPage}"><a href="javascript:changePage(0,${pageResultSet.pageInfo.totalRow});">首页</a>&nbsp;&nbsp;<a href="javascript:changePage(${pageResultSet.pageInfo.currentPage - 1},${pageResultSet.pageInfo.totalRow});">上一页</a>&nbsp;&nbsp;下一页&nbsp;&nbsp;末页</c:if>